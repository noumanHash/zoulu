...
const DateSlider = (props) => {
  ...
  var time = next30Days?.map((data, index) => {
    return {
      day: days[new Date(data).getDay()],
      date: new Date(data).getDate(),
      month: month[new Date(data).getMonth()],
              ...
              >
                      ...
                      ? {
                          color:
                            moment(props?.cart?.date)
                              .format("dddd")
                              .slice(0, 3) == slideContent.day &&
                            moment(props?.cart?.date)
                              .format("MMMM")
                              .slice(0, 3) == slideContent.month &&
                ...
                <p
                  ...
                  style={
                    ...
                    moment(props?.cart?.date).format("DD") ==
                      slideContent.date &&
                    moment(props?.cart?.date).format("MMMM").slice(0, 3) ==
                      slideContent.month
                      ? {
                          color: "#3a7ae4",
                          marginLeft: "4px",
